    ...
    <header class="relative">
      <div class="bg-gray-900 pt-6">
        <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
          ...
          <div class="hidden md:flex md:items-center md:space-x-6 pl-6">
            <nuxt-link to="/login" class="text-base font-medium text-white hover:text-gray-300">
              Log in
            </nuxt-link>
            <nuxt-link to="/signup" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700">
               Create an account
            </nuxt-link>
          </div>
        </nav>
            ...
            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
              <div class="lg:py-24">
                <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                  <span class="block">Quickmarketing Campaigns</span>
